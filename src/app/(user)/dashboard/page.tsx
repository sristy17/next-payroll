...
import { ChevronRight, ChevronUp, ChevronDown, Dot, MoreHorizontal } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
            ...
            <div className="flex items-end justify-between">
              <span className="text-3xl font-bold text-foreground">$974,99</span>
              <span className="text-green-500 flex items-center text-sm font-medium">
                <ChevronUp className="w-4 h-4 mr-0.5" /> 7.85%
              </span>
            </div>
            <p className="text-muted-foreground text-xs mt-1">from last week</p>
          </div>
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
            ...
            <div className="flex items-end justify-between">
              <span className="text-3xl font-bold text-foreground">$425,30</span>
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
            ...
            <div className="flex items-end justify-between">
              <span className="text-3xl font-bold text-foreground">$549,61</span>
              <span className="text-green-500 flex items-center text-sm font-medium">
          ...
          <div className="bg-card p-6 rounded-lg shadow-sm border border-border">
            ...
            <div className="space-y-4">
              {mockTaxFilings.map((filing) => (
                <div
                  key={filing.id}
                  className="flex justify-between items-center py-2 border-b last:border-b-0 border-border"
                >
                  <div>
                    <p className="font-medium text-foreground">{filing.name}</p>
              ...
              {mockTransactions.map((transaction) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center text-muted-foreground text-lg font-bold uppercase">
        ...
        <div className="bg-card p-6 rounded-lg shadow-sm border border-border mt-6">
          ...
          <div className="flex justify-center items-center space-x-6 mt-4 text-sm">
            <div className="flex items-center">
              ...
              <span className="text-foreground">Money Income</span>
            </div>
            <div className="flex items-center">
              <Dot className="w-6 h-6 text-green-500" />
              <span className="text-foreground">Current State</span>
            </div>
          </div>
        </div>
      </div>
