...
```
avoid using just SUPABASE_URL/ANON_KEY to avoid conflicts
###note - i have added a sample dummy .env file (just replace your orginial credentials in it when running in your pc locally)
