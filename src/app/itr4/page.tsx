  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col" style={{paddingLeft: 40, paddingRight: 32, paddingTop: 32, paddingBottom: 0}}>
        ...
        <main className="flex-1 pb-2" style={{paddingTop: 0, maxWidth: 'none'}}>
          <h1 className="text-2xl font-semibold text-gray-900 mb-1 mt-2">{username ? `Hello, ${username}!` : "Hello!"}</h1>
          <p className="text-gray-800 mb-2 text-sm">Send and receive funds with pleasure.</p>
          <h2 className="text-base font-semibold text-gray-900 mb-1 mt-5">Generate ITR -4 (Sugam)</h2>
          ...
          <div className="flex items-center mt-5 mb-4">
            ...
            <span className="font-semibold text-base text-gray-900">Who Can File ITR-4?</span>
          </div>
          <p className="text-gray-800 mb-2 text-sm">
          ...
          <p className="text-gray-800 mt-5 mb-2 text-sm font-semibold">
            By using Next PAY to generate and file your ITR-4 (Sugam), you agree to the following terms and conditions:
          </p>
          <ul className="list-disc pl-6 text-gray-800 mb-2 text-sm">
          ...
          <Button
            className="w-full rounded-xl font-semibold text-white text-base shadow-md mt-8"
            style={{
              background: 'linear-gradient(90deg, #2B9348 0%, #00543C 100%)',
              height: 44,
              boxShadow: '0 2px 8px 0 rgba(0,127,95,0.10)'
